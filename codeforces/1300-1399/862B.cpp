...
// Verdict: Accepted
// URL: https://codeforces.com/contest/862/submission/388182482
// Solved on: 2026-08-23T20:44:59.910Z
...
int32_t main() {
    ...
    auto dfs1 = [](vvi &a, int root = 0) {
        int n = a.size();
        vi sz(n), par(n), dep(n), hc(n, -1);
        ...
        dfssz(root, -1);
        return make_tuple(sz, par, dep, hc);
    };
    auto [sz, par, dep, hc] = dfs1(a, 0);
    vi c(2);
    FOR(i, n) {
        c[dep[i] % 2]++;
    }
