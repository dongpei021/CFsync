// Problem: E - FTL
// Platform: codeforces
// Contest: Contest-1743
// Rating/Difficulty: 2400
// Language: C++20 (GCC 13-64)
// Verdict: Accepted
// URL: https://codeforces.com/contest/1743/submission/388651369
// Solved on: 2026-08-28T07:57:36.967Z
...
int32_t main() {
    ...
    FOR(i, 2) {
        ...
        FOR(ki, 1, h) {
            int kj = t[i] * ki / t[j];
            if (kj) {
                int dm = (ki - 1) * (p[i] - s) + (kj - 1) * (p[j] - s) + p[i] + p[j] - s;
                int tt = t[i] * ki;
                if (dm > h + OFF) {
                    break;
                }
